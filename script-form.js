window.cfields = { "20": "consentimentoprivacidade", "4": "utm_medium", "5": "utm_source", "6": "utm_content", "7": "utm_term", "8": "utm_campaign", "11": "url_origem", "13": "lead_dispositivo" };
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        _show_error("109", "Desculpe, seu envio falhou. Deixe suas respostas mais curtas e tente novamente.");
      } else {
        _show_error("109", "Desculpe, seu envio falhou. Tente novamente.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove('processing');
    }
